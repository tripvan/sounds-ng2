...
//     private trackerTimeoutObservable = Observable.interval(50); 
//     // dependencies
...
//             xSliderWidth = Math.max(config.minSliderLength, parseInt((cw * cw / contentWidth).toString(), 10));
//             xSliderLeft = parseInt((contentLeft * (cw - xSliderWidth) / (contentWidth - cw)).toString(), 10);
...
//             ySliderHeight = Math.max(config.minSliderLength, parseInt((ch * ch / contentHeight).toString(), 10));
//             ySliderTop = parseInt((contentTop * (ch - ySliderHeight) / (contentHeight - ch)).toString(), 10);
...
//               scrollbarXStyles = {bottom: null, top: null, left: 0, width: toPix(containerWidth), display: isXActive || showAlways ? "inherit" : "none"};
...
//               scrollbarYStyles = {right: null, left: null, top: 0, height: toPix(containerHeight), display: isYActive || showAlways ? "inherit" : "none"};
...
//           if (spySetter.spyX) {
//             spySetter.spyX($scope, parseInt(contentLeft.toString(), 10));
//             needsDigest = true;
//           }
//           if (spySetter.spyY) {
//             spySetter.spyY($scope, parseInt(contentTop.toString(), 10));
//             needsDigest = true;
//           }
//           if (needsDigest) {
//             safeDigest();
...
//                 deltaContent = isTouchDevice ? -deltaSlider : parseInt((deltaSlider * (contentWidth - containerWidth) / (containerWidth - xSliderWidth)).toString(), 10);
...
//                 deltaContent = isTouchDevice ? -deltaSlider : parseInt((deltaSlider * (contentHeight - containerHeight) / (containerHeight - ySliderHeight)).toString(), 10);
...
//           var halfOfScrollbarLength = parseInt((xSliderWidth / 2).toString(), 10),
...
//           var halfOfScrollbarLength = parseInt((ySliderHeight / 2).toString(), 10),
